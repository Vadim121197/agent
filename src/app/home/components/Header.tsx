...
import { ConnectWallet } from '@/src/components/connect'
...
const MobileMenu = ({
	...
	return (
		<>
			...
			{/* Sliding menu */}
			<div
				className={`fixed z-50 left-0 top-0 h-full w-80 bg-white transform transition-transform duration-300 ease-in-out ${
